...
;
sp_tableoption 'SAKAI_SITE_PROPERTY', 'large value types out of row', 'true'
;

ALTER TABLE SAKAI_SITE_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_PROPERTY_PK PRIMARY KEY (SITE_ID, NAME)
...
;
sp_tableoption 'SAKAI_SITE', 'large value types out of row', 'true'
;
ALTER TABLE SAKAI_SITE
       ADD  CONSTRAINT SAKAI_SITE_PK PRIMARY KEY (SITE_ID)


ALTER TABLE SAKAI_SITE_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_PROPERTY_FK FOREIGN KEY (SITE_ID)
...
(
       PAGE_ID              NVARCHAR (99) NOT NULL,
       SITE_ID              NVARCHAR (99) NOT NULL,
       TITLE                NVARCHAR (99) NULL,
       LAYOUT               CHAR(1) NULL,
       SITE_ORDER           INTEGER NOT NULL,
       POPUP                CHAR(1) DEFAULT '0'
                                   CHECK (POPUP IN (1, 0))
)

ALTER TABLE SAKAI_SITE_PAGE
       ADD  CONSTRAINT SAKAI_SITE_PAGE_PK PRIMARY KEY (PAGE_ID)

ALTER TABLE SAKAI_SITE_PAGE
       ADD  CONSTRAINT SAKAI_SITE_PAGE_FK FOREIGN KEY (SITE_ID)
                             REFERENCES SAKAI_SITE (SITE_ID)
...
;
sp_tableoption 'SAKAI_SITE_PAGE_PROPERTY', 'large value types out of row', 'true'
;
ALTER TABLE SAKAI_SITE_PAGE_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_PAGE_PROPERTY_PK PRIMARY KEY (PAGE_ID, NAME)

ALTER TABLE SAKAI_SITE_PAGE_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_PAGE_PROPERTY_FK1 FOREIGN KEY (PAGE_ID)
                             REFERENCES SAKAI_SITE_PAGE (PAGE_ID)

ALTER TABLE SAKAI_SITE_PAGE_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_PAGE_PROPERTY_FK2 FOREIGN KEY (SITE_ID)
                             REFERENCES SAKAI_SITE (SITE_ID)
...
(
       TOOL_ID              NVARCHAR (99) NOT NULL,
       PAGE_ID              NVARCHAR (99) NOT NULL,
       SITE_ID              NVARCHAR (99) NOT NULL,
       REGISTRATION         NVARCHAR (99) NOT NULL,
       PAGE_ORDER           INTEGER NOT NULL,
       TITLE                NVARCHAR (99) NULL,
       LAYOUT_HINTS         NVARCHAR (99) NULL
)

ALTER TABLE SAKAI_SITE_TOOL
       ADD  CONSTRAINT SAKAI_SITE_TOOL_PK1 PRIMARY KEY (TOOL_ID)

ALTER TABLE SAKAI_SITE_TOOL
       ADD  CONSTRAINT SAKAI_SITE_TOOL_FK1 FOREIGN KEY (PAGE_ID)
                             REFERENCES SAKAI_SITE_PAGE (PAGE_ID)
ALTER TABLE SAKAI_SITE_TOOL
       ADD  CONSTRAINT SAKAI_SITE_TOOL_FK2 FOREIGN KEY (SITE_ID)
                             REFERENCES SAKAI_SITE (SITE_ID)
...
;
sp_tableoption 'SAKAI_SITE_TOOL_PROPERTY', 'large value types out of row', 'true'
;
ALTER TABLE SAKAI_SITE_TOOL_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_TOOL_PROPERTY_PK PRIMARY KEY (TOOL_ID, NAME)

ALTER TABLE SAKAI_SITE_TOOL_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_TOOL_PROPERTY_FK1 FOREIGN KEY (TOOL_ID)
                             REFERENCES SAKAI_SITE_TOOL (TOOL_ID)

ALTER TABLE SAKAI_SITE_TOOL_PROPERTY
       ADD  CONSTRAINT SAKAI_SITE_TOOL_PROPERTY_FK2 FOREIGN KEY (SITE_ID)
                             REFERENCES SAKAI_SITE (SITE_ID)
...
ALTER TABLE SAKAI_SITE_USER
       ADD  CONSTRAINT SAKAI_SITE_USER_PK PRIMARY KEY (SITE_ID, USER_ID)

ALTER TABLE SAKAI_SITE_USER
       ADD  CONSTRAINT SAKAI_SITE_USER_FK FOREIGN KEY (SITE_ID)
                             REFERENCES SAKAI_SITE (SITE_ID)
...
INSERT INTO SAKAI_SITE VALUES('~admin', 'Administration Workspace', null, null, 'Administration Workspace', null, null, null, 1, 0, 0, '', null, null, null, null, 0, 1, 0, null )
...
INSERT INTO SAKAI_SITE_PAGE VALUES('~admin-250', '~admin', 'Aliases', '0', 5, '0' )
INSERT INTO SAKAI_SITE_TOOL VALUES('~admin-260', '~admin-250', '~admin', 'sakai.aliases', 1, 'Aliases', NULL )
INSERT INTO SAKAI_SITE_PAGE VALUES('~admin-300', '~admin', 'Sites', '0', 3, '0' )
INSERT INTO SAKAI_SITE_TOOL VALUES('~admin-310', '~admin-300', '~admin', 'sakai.sites', 1, 'Sites', NULL )
INSERT INTO SAKAI_SITE_PAGE VALUES('~admin-350', '~admin', 'Realms', '0', 4, '0' )
...
INSERT INTO SAKAI_SITE_PAGE VALUES('~admin-600', '~admin', 'On-Line', '0', 11, '0' )
...
INSERT INTO SAKAI_SITE VALUES('!admin', 'Administration Workspace', null, null, 'Administration Workspace', null, null, null, 1, 0, 0, '', null, null, null, null, 0, 0, 0, null )
INSERT INTO SAKAI_SITE_PAGE VALUES('!admin-100', '!admin', 'Home', '0', 1, '0' )
INSERT INTO SAKAI_SITE_TOOL VALUES('!admin-110', '!admin-100', '!admin', 'sakai.motd', 1, 'Message of the Day', NULL )
INSERT INTO SAKAI_SITE_TOOL VALUES('!admin-120', '!admin-100', '!admin', 'sakai.iframe.myworkspace', 2, 'My Workspace Information', NULL )
INSERT INTO SAKAI_SITE_PAGE VALUES('!admin-200', '!admin', 'Users', '0', 2, '0' )
...
INSERT INTO SAKAI_SITE VALUES('!error', 'Site Unavailable', null, null, 'The site you requested is not available.', null, null, null, 1, 0, 0, '', null, null, null, null, 1, 0, 0, null )
UPDATE SAKAI_SITE SET CREATEDBY='admin' WHERE SITE_ID = '!error'
UPDATE SAKAI_SITE SET MODIFIEDBY='admin' WHERE SITE_ID = '!error'
UPDATE SAKAI_SITE SET MODIFIEDON='2003-06-24 12:10:53.597' WHERE SITE_ID = '!error'
UPDATE SAKAI_SITE SET CREATEDON='2003-06-24 04:15:08.851' WHERE SITE_ID = '!error'
...
INSERT INTO SAKAI_SITE VALUES('!urlError', 'Invalid URL', null, null, 'The URL you entered is invalid.  SOLUTIONS: Please check for spelling errors or typos.  Make sure you are using the right URL.  Type a URL to try again.', null, null, null, 1, 0, 0, '', null, null, null, null, 1, 0, 0, null )
...
UPDATE SAKAI_SITE SET MODIFIEDON='2003-06-24 12:10:53.597' WHERE SITE_ID = '!urlError'
UPDATE SAKAI_SITE SET CREATEDON='2003-06-24 04:15:08.851' WHERE SITE_ID = '!urlError'
...
INSERT INTO SAKAI_SITE VALUES('!gateway', 'Gateway', null, null, 'The Gateway Site', null, null, null, 1, 0, 0, '', null, null, null, null, 1, 0, 0, null )
UPDATE SAKAI_SITE SET MODIFIEDBY='admin' WHERE SITE_ID = '!gateway'
UPDATE SAKAI_SITE SET MODIFIEDON='2003-11-26 03:45:22.061' WHERE SITE_ID = '!gateway'
...
INSERT INTO SAKAI_SITE VALUES('!user', 'My Workspace', null, null, 'My Workspace Site', null, null, null, 1, 0, 0, '', null, null, null, null, 1, 0, 0, null )
...
INSERT INTO SAKAI_SITE_PAGE VALUES('!user-500', '!user', 'Site Setup', '0', 7, '0' )
INSERT INTO SAKAI_SITE_TOOL VALUES('!user-510', '!user-500', '!user', 'sakai.sitesetup', 1, 'Site Setup', NULL )
...
INSERT INTO SAKAI_SITE VALUES('!worksite', 'worksite', null, null, null, '', '', null, 0, 0, 0, 'access', null, null, null, null, 1, 0, 0, null )
