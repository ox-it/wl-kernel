...
public class ContentHostingServiceTest extends SakaiKernelTestBase {
	...
	public void testMimeDetection() throws Exception {
		...
		List <String> fileNames = Arrays.asList("testEXCEL.mp3","testWORD.doc","testHTML.html","testEXCEL","LSNBLDR-359-snippet.html", "jquery-1.6.1.min.js");
		List <String> expectedMimes = Arrays.asList("application/vnd.ms-excel","application/msword","text/html","application/vnd.ms-excel","text/html","application/javascript");
